...
| Independent per-claim verification | Answering | IMPLEMENTED | M3 | `VerifierProvider`, verifier-decides mapping | rejection/downgrade/conflict gates | Verifier quality bounded by local 8B model |
